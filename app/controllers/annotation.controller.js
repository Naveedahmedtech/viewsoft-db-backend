 ...
 *               createdBy:
 *                 type: string
 *                 description: The identifier of the user who created the annotation.
 *                 example: '1'
 *     responses:
 *       201:
 ...
 *               updatedBy:
 *                 type: string
 *                 description: Identifier of the user/system updating the annotation.
 *                 example: "collab"
 *     responses:
 *       200:
...
exports.update = async (req, res) => {
  ...
  // Allow partial updates for annotation payload and updater identifier.
  const body = {};
  if (Object.prototype.hasOwnProperty.call(req.body, "data")) {
    body.data = req.body.data;
  }
  if (Object.prototype.hasOwnProperty.call(req.body, "updatedBy")) {
    body.updatedBy = req.body.updatedBy;
  }

  if (Object.keys(body).length === 0) {
    res.status(400).send({
      message: "No updatable fields provided. Send at least one of: data, updatedBy."
    });
    return;
  }
